...
;; produce true if pattern matches list of string, false otherwise
...
(check-expect (pattern-match? (list "A" "N" "A") (list "a" "1" "b")) true)
(check-expect (pattern-match? (list "A" "N" "A") (list "a" "b" "c")) false)
